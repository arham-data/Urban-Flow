const paths = {
  ...
  chat: (<><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/><line x1="8" y1="10" x2="16" y2="10"/><line x1="8" y1="14" x2="12" y2="14"/></>),
  ...
  radio: (<><circle cx="12" cy="12" r="2"/><circle cx="6" cy="12" r="0.5"/><circle cx="18" cy="12" r="0.5"/><path d="M16.24 7.76a6 6 0 0 1 0 8.48"/><path d="M7.76 16.24a6 6 0 0 1 0-8.48"/></>),
  car: (<><path d="M5 14l1.3-4.2A2 2 0 0 1 8.2 8.5h7.6a2 2 0 0 1 1.9 1.3L19 14"/><path d="M4 14h16a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1h-1.5"/><circle cx="7" cy="18" r="1.8"/><circle cx="17" cy="18" r="1.8"/><path d="M9 18h6"/><path d="M19 18h-.5"/></>),
  location: (<><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0z"/><circle cx="12" cy="10" r="3"/></>),
  business: (<><rect x="4" y="2" width="16" height="20" rx="1"/><path d="M9 22v-4h6v4"/><path d="M8 6h.01M12 6h.01M16 6h.01M8 10h.01M12 10h.01M16 10h.01M8 14h.01M12 14h.01M16 14h.01"/></>),
  ...
  map: (<><path d="M9 4L3 6v13l6-2 6 2 6-2V4l-6 2-6-2z"/><path d="M9 4v13"/><path d="M15 6v13"/></>),
  arrow: (<><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></>),
  "arrow-down": (<><line x1="12" y1="5" x2="12" y2="19"/><polyline points="19 12 12 19 5 12"/></>),
  "arrow-up": (<><line x1="12" y1="19" x2="12" y2="5"/><polyline points="5 12 12 5 19 12"/></>),
  send: (<><line x1="22" y1="2" x2="11" y2="13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></>),
  trending: (<><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></>),
  cubes: (<><rect x="2" y="6" width="6" height="6" rx="1"/><rect x="8" y="6" width="6" height="6" rx="1"/><rect x="14" y="6" width="6" height="6" rx="1"/><rect x="4" y="14" width="6" height="6" rx="1"/><rect x="10" y="14" width="6" height="6" rx="1"/><rect x="16" y="14" width="6" height="6" rx="1"/></>),
  create: (<><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"/><path d="M15 5l4 4"/></>),
  ...
  fingerprint: (<><path d="M12 11a4 4 0 0 1 4 4c0 4-1 5-1 5"/><path d="M12 3a8 8 0 0 1 8 8c0 1.5-.4 3-1.2 4.5"/><path d="M12 7a5 5 0 0 1 5 5c0 2-1 3.5-1 3.5"/><path d="M4 11a8 8 0 0 1 4.5-7.2"/><path d="M12 15a3 3 0 0 1 3 3"/></>),
  ...
  receipt: (<><path d="M4 2v20l2-1.4 2 1.4 2-1.4 2 1.4 2-1.4 2 1.4 2-1.4 2 1.4V2l-2 1.4L16 2l-2 1.4L12 2l-2 1.4L8 2 6 3.4 4 2z"/><line x1="8" y1="8" x2="16" y2="8"/><line x1="8" y1="12" x2="16" y2="12"/></>),
